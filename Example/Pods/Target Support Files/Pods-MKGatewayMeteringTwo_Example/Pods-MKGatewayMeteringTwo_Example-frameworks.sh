...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MKGatewayMeteringTwo/MKGatewayMeteringTwo.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MKIotCloudManager/MKIotCloudManager.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MKScannerCommonModule/MKScannerCommonModule.framework"
