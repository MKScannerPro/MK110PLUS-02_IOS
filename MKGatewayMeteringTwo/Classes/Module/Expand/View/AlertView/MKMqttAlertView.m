...
@implementation MKMqttAlertViewModel
@end

@interface MKMqttAlertView ()
...
@implementation MKMqttAlertView

- (void)dealloc {
    NSLog(@"MKMqttAlertView销毁");
}
...
- (void)showWithModel:(MKMqttAlertViewModel *)dataModel
    ...
    if (!dataModel || ![dataModel isKindOfClass:MKMqttAlertViewModel.class]) {
        return;
    }
