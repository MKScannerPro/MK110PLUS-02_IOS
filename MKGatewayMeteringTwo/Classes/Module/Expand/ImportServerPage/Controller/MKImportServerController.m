...
@interface MKImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKImportServerController

- (void)dealloc {
    NSLog(@"MKImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(mk_selectedServerParams:)]) {
        [self.delegate mk_selectedServerParams:model.leftMsg];
    }
...
- (void)loadSubViews {
    self.defaultTitle = (ValidStr(self.title) ? self.title : @"Settings for Server");
