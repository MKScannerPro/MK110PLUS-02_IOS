...
@implementation MKGTAdvTriggerCellModel
@end

@interface MKGTAdvTriggerCell ()
...
@implementation MKGTAdvTriggerCell

+ (MKGTAdvTriggerCell *)initCellWithTableView:(UITableView *)tableView {
    MKGTAdvTriggerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKGTAdvTriggerCellIdenty"];
    if (!cell) {
        cell = [[MKGTAdvTriggerCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKGTAdvTriggerCellIdenty"];
    }
    return cell;
}
...
- (void)setButtonPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(gt_advTriggerCell_setPressed:interval:txPower:)]) {
        [self.delegate gt_advTriggerCell_setPressed:self.dataModel.index
...
#pragma mark - setter
- (void)setDataModel:(MKGTAdvTriggerCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKGTAdvTriggerCellModel.class]) {
        return;
    }
