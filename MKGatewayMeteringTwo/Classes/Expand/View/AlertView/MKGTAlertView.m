...
@implementation MKGTAlertViewModel
@end

@interface MKGTAlertView ()
...
@implementation MKGTAlertView

- (void)dealloc {
    NSLog(@"MKGTAlertView销毁");
}
...
- (void)showWithModel:(MKGTAlertViewModel *)dataModel
    ...
    if (!dataModel || ![dataModel isKindOfClass:MKGTAlertViewModel.class]) {
        return;
    }
