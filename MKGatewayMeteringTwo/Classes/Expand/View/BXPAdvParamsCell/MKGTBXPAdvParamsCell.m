...
@implementation MKGTBXPAdvParamsCellModel

- (CGFloat)fetchCellHeight {
    if (self.slotType == MKGTBXPAdvParamsCellSlotTypeNoData) {
        return 44.f;
    }
    return 150.f;
}
...
@interface MKGTBXPAdvParamsCell ()
...
@implementation MKGTBXPAdvParamsCell

+ (MKGTBXPAdvParamsCell *)initCellWithTableView:(UITableView *)tableView {
    MKGTBXPAdvParamsCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKGTBXPAdvParamsCellIdenty"];
    if (!cell) {
        cell = [[MKGTBXPAdvParamsCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKGTBXPAdvParamsCellIdenty"];
    }
    return cell;
}
...
- (void)layoutSubviews {
    ...
    if (self.dataModel.slotType == MKGTBXPAdvParamsCellSlotTypeNoData) {
...
- (void)setButtonPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(gt_BXPAdvParamsCell_setPressedWithSlotIndex:interval:txPower:)]) {
        [self.delegate gt_BXPAdvParamsCell_setPressedWithSlotIndex:self.dataModel.slotIndex
...
#pragma mark - setter
- (void)setDataModel:(MKGTBXPAdvParamsCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKGTBXPAdvParamsCellModel.class]) {
        return;
    }
    ...
    if (_dataModel.slotType == MKGTBXPAdvParamsCellSlotTypeNoData) {
        [self setNeedsLayout];
        return;
    }
...
- (NSString *)getSlotTypeString:(MKGTBXPAdvParamsCellSlotType)slotType {
    if (slotType == MKGTBXPAdvParamsCellSlotTypeUID) {
        return @"UID";
    }
    if (slotType == MKGTBXPAdvParamsCellSlotTypeURL) {
        return @"URL";
    }
    if (slotType == MKGTBXPAdvParamsCellSlotTypeTLM) {
        return @"TLM";
    }
    if (slotType == MKGTBXPAdvParamsCellSlotTypeEID) {
        return @"EID";
    }
    if (slotType == MKGTBXPAdvParamsCellSlotTypeDeviceInfo) {
        return @"Device info";
    }
    if (slotType == MKGTBXPAdvParamsCellSlotTypeiBeacon) {
        return @"iBeacon";
    }
    if (slotType == MKGTBXPAdvParamsCellSlotTypeAccelerometer) {
        return @"ACC";
    }
    if (slotType == MKGTBXPAdvParamsCellSlotTypeHT) {
        return @"TH";
    }
    if (slotType == MKGTBXPAdvParamsCellSlotTypeTag) {
        return @"Tag";
    }
    if (slotType == MKGTBXPAdvParamsCellTriggerTypeSingleClick) {
        return @"Single click button";
    }
    return @"No data";
}

- (NSString *)getTriggerTypeString:(MKGTBXPAdvParamsCellTriggerType)triggerType {
    if (triggerType == MKGTBXPAdvParamsCellTriggerTypeNull) {
        return @"Off";
    }
    if (triggerType == MKGTBXPAdvParamsCellTriggerTypeTemperature) {
        return @"Temperature";
    }
    if (triggerType == MKGTBXPAdvParamsCellTriggerTypeHumidity) {
        return @"Humidity";
    }
    if (triggerType == MKGTBXPAdvParamsCellTriggerTypeDoubleClick) {
        return @"Double click button";
    }
    if (triggerType == MKGTBXPAdvParamsCellTriggerTypeTripleClick) {
        return @"Triple click button";
    }
    if (triggerType == MKGTBXPAdvParamsCellTriggerTypeMove) {
        return @"Devices moves";
    }
    if (triggerType == MKGTBXPAdvParamsCellTriggerTypeLight) {
        return @"Light";
    }
    if (triggerType == MKGTBXPAdvParamsCellTriggerTypeSingleClick) {
        return @"Single click button";
    }
    return @"";
}
