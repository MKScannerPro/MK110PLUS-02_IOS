...
@interface MKGTAdvTriggerTwoStateCellModel : NSObject
...
@protocol MKGTAdvTriggerTwoStateCellDelegate <NSObject>
...
@interface MKGTAdvTriggerTwoStateCell : MKBaseCell

@property (nonatomic, weak)id <MKGTAdvTriggerTwoStateCellDelegate>delegate;

@property (nonatomic, strong)MKGTAdvTriggerTwoStateCellModel *dataModel;
