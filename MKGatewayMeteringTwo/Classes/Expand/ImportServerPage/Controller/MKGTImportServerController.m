...
@interface MKGTImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKGTImportServerController

- (void)dealloc {
    NSLog(@"MKGTImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(gt_selectedServerParams:)]) {
        [self.delegate gt_selectedServerParams:model.leftMsg];
    }
...
- (void)loadSubViews {
    self.defaultTitle = @"Settings for Server";
