//
//  MKGTUploadOptionV2Controller.m
...
@interface MKGTUploadOptionV2Controller ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKGTUploadOptionV2Model *dataModel;

@end

@implementation MKGTUploadOptionV2Controller
...
- (void)mk_scanner_filterValueChanged:(NSInteger)dataListIndex index:(NSInteger)index {
    ...
    if (index == 2) {
        ...
        MKScannerFilterCellModel *cellModel = self.section3List[1];
        cellModel.dataListIndex = dataListIndex;
        return;
    }
}
...
- (void)filterByRawData {
    ...
    model.supportTof = YES;
    model.supportNanoBeacon = YES;
...
- (void)duplicateDataFilter {
    ...
    MKScannerDuplicateDataFilterController *vc = [[MKScannerDuplicateDataFilterController alloc] init];
    [self.navigationController pushViewController:vc animated:YES];
}
...
- (void)uploadDataInterval {
    MKGTDataUploadIntervalModel *model = [[MKGTDataUploadIntervalModel alloc] init];
    MKScannerDataUploadIntervalController *vc = [[MKScannerDataUploadIntervalController alloc] initWithProtocol:model];
    [self.navigationController pushViewController:vc animated:YES];
}
...
- (void)loadSection3Datas {
    MKScannerFilterCellModel *cellModel1 = [[MKScannerFilterCellModel alloc] init];
    cellModel1.index = 1;
    ...
    MKScannerFilterCellModel *cellModel2 = [[MKScannerFilterCellModel alloc] init];
    cellModel2.index = 2;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMeteringTwo", @"MKGTUploadOptionV2Controller", @"gt_saveIcon.png")
...
- (MKGTUploadOptionV2Model *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGTUploadOptionV2Model alloc] init];
    }
    return _dataModel;
}
