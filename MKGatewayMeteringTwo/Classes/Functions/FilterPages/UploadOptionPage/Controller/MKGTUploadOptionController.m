...
@property (nonatomic, strong)MKGTUploadOptionModel *dataModel;

@end

@implementation MKGTUploadOptionController
...
- (MKGTUploadOptionModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGTUploadOptionModel alloc] init];
    }
    return _dataModel;
}
