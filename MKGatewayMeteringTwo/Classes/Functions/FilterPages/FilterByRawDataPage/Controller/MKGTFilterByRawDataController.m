//
//  MKGTFilterByRawDataController.m
...
@interface MKGTFilterByRawDataController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKGTFilterByRawDataModel *dataModel;

@end

@implementation MKGTFilterByRawDataController

- (void)dealloc {
    NSLog(@"MKGTFilterByRawDataController销毁");
}
...
- (MKGTFilterByRawDataModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGTFilterByRawDataModel alloc] init];
    }
    return _dataModel;
}
