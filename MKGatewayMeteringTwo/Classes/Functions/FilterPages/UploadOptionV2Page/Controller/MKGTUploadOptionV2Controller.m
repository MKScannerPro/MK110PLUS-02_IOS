...
- (void)gt_filterValueChanged:(NSInteger)dataListIndex index:(NSInteger)index {
    ...
    if (index == 2) {
        ...
        MKGTFilterCellModel *cellModel = self.section3List[1];
        cellModel.dataListIndex = dataListIndex;
        return;
    }
}
...
- (void)filterByRawData {
    MKGTFilterByRawDataV2Controller *vc = [[MKGTFilterByRawDataV2Controller alloc] init];
    [self.navigationController pushViewController:vc animated:YES];
}
...
- (void)uploadDataInterval {
    MKGTDataUploadIntervalController *vc = [[MKGTDataUploadIntervalController alloc] init];
    [self.navigationController pushViewController:vc animated:YES];
}
...
- (void)loadSection3Datas {
    MKGTFilterCellModel *cellModel1 = [[MKGTFilterCellModel alloc] init];
    cellModel1.index = 1;
    ...
    MKGTFilterCellModel *cellModel2 = [[MKGTFilterCellModel alloc] init];
    cellModel2.index = 2;
