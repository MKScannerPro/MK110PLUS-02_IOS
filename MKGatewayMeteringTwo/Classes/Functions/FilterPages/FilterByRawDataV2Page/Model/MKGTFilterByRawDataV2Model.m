...
@interface MKGTFilterByRawDataV2Model ()
...
@implementation MKGTFilterByRawDataV2Model
...
- (BOOL)readFilterByRawData {
    ...
    [MKGTMQTTInterface gt_readFilterByRawDataStatusWithMacAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
