//
//  MKGTBXPButtonCRAccDataPageModel.m
...
@implementation MKGTBXPButtonCRAccDataPageModel

- (void)dealloc {
    NSLog(@"MKGTBXPButtonCRAccDataPageModel销毁");
...
- (void)notifyAccData:(BOOL)isOn
    ...
    [MKGTMQTTInterface gt_bxpBtnCRNotifyAccDataWithBleMac:[MKGTManageBleDevicesManager shared].bleMac
                                                   notify:isOn
