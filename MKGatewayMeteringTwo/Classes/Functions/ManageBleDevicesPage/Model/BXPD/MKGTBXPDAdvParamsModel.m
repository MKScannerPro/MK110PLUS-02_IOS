...
@implementation MKGTBXPDAdvParamsModel
...
- (void)readAdvParamsWithSucBlock:(void (^)(NSArray *dataList))sucBlock
    ...
    [MKGTMQTTInterface gt_readBXPDAdvParamsWithBleMacAddress:[MKGTManageBleDevicesManager shared].bleMac
...
- (void)configAdvParamsWithChannel:(NSInteger)channel
                       ...
                       failedBlock:(void (^)(NSError *error))failedBlock {
    [MKGTMQTTInterface gt_configBXPDAdvParamsWithChannel:channel
                                                interval:interval
                                                 txPower:txPower
