...
- (void)readAdvParamsWithSucBlock:(void (^)(NSArray *dataList))sucBlock
    ...
    [MKGTMQTTInterface gt_bxpBtnReadAdvParamsWithBleMac:[MKGTManageBleDevicesManager shared].bleMac
...
- (void)configAdvParams:(NSDictionary *)params
            ...
            failedBlock:(void (^)(NSError *error))failedBlock {
    [MKGTMQTTInterface gt_bxpBtnConfigAdvParamsWithParams:params
