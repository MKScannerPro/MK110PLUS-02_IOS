//
//  MKGTTofSensorParamsPageModel.m
...
@interface MKGTTofSensorParamsPageModel ()
...
@implementation MKGTTofSensorParamsPageModel
...
- (BOOL)readSensorParams {
    ...
    [MKGTMQTTInterface gt_readMKTofSensorParamsWithBleMacAddress:[MKGTManageBleDevicesManager shared].bleMac
...
- (BOOL)readDistanceMode {
    __block BOOL success = NO;
    [MKGTMQTTInterface gt_readMKTofRangingModeWithBleMacAddress:[MKGTManageBleDevicesManager shared].bleMac
                                                     macAddress:[MKScannerDeviceModelManager shared].macAddress
                                                          topic:[MKScannerDeviceModelManager shared].subscribedTopic
                                                       sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configDistanceMode {
    __block BOOL success = NO;
    [MKGTMQTTInterface gt_configMKTofRangingMode:self.distanceMode
                                          bleMac:[MKGTManageBleDevicesManager shared].bleMac
                                      macAddress:[MKScannerDeviceModelManager shared].macAddress
                                           topic:[MKScannerDeviceModelManager shared].subscribedTopic
                                        sucBlock:^(id  _Nonnull returnData) {
