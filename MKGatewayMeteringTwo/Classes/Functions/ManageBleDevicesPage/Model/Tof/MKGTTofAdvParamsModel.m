...
- (void)readDataWithSucBlock:(void (^)(void))sucBlock failedBlock:(void (^)(NSError *error))failedBlock {
    [MKGTMQTTInterface gt_readMKTofAdvParamsWithBleMacAddress:[MKGTManageBleDevicesManager shared].bleMac
...
- (void)configDataWithSucBlock:(void (^)(void))sucBlock failedBlock:(void (^)(NSError *error))failedBlock {
    [MKGTMQTTInterface gt_configMKTofAdvParamsWithInterval:[self.interval integerValue]
