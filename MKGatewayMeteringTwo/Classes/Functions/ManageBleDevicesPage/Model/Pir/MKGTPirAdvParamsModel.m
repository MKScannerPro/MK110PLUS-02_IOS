...
- (void)readDataWithSucBlock:(void (^)(void))sucBlock failedBlock:(void (^)(NSError *error))failedBlock {
    [MKGTMQTTInterface gt_readMKPirAdvParamsWithBleMacAddress:[MKGTManageBleDevicesManager shared].bleMac
...
- (void)configDataWithSucBlock:(void (^)(void))sucBlock failedBlock:(void (^)(NSError *error))failedBlock {
    [MKGTMQTTInterface gt_configMKPirAdvParamsWithInterval:[self.interval integerValue]
