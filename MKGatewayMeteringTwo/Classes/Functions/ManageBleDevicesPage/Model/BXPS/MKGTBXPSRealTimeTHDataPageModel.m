//
//  MKGTBXPSRealTimeTHDataPageModel.m
...
@implementation MKGTBXPSRealTimeTHDataPageModel

- (void)dealloc {
    NSLog(@"MKGTBXPSRealTimeTHDataPageModel销毁");
...
- (void)notifyRealTimeHTData:(BOOL)isOn
    ...
    [MKGTMQTTInterface gt_bxpBXPSNotifyRealTimeHTDataWithBleMac:[MKGTManageBleDevicesManager shared].bleMac
                                                         notify:isOn
