...
@implementation MKGTBXPTAccDataPageModel

- (void)dealloc {
    NSLog(@"MKGTBXPTAccDataPageModel销毁");
...
- (void)notifyAccData:(BOOL)isOn
    ...
    [MKGTMQTTInterface gt_bxpBXPTNotifyAccDataWithBleMac:[MKGTManageBleDevicesManager shared].bleMac
                                                  notify:isOn
