...
@interface MKGTButtonDFUV2Model ()
...
- (BOOL)startDfu {
    ...
    [MKGTMQTTInterface gt_startBXPDfuWithBeaconType:self.type firmwareUrl:self.firmwareUrl dataUrl:self.dataUrl dfuList:@[@{@"mac":self.bleMac,@"password":password}] macAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
