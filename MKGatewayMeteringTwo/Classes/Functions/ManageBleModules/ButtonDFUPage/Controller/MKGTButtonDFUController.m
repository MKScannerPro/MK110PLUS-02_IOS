...
@interface MKGTButtonDFUController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKGTButtonDFUModel *dataModel;
...
@implementation MKGTButtonDFUController

- (void)dealloc {
    NSLog(@"MKGTButtonDFUController销毁");
...
- (MKGTButtonDFUModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGTButtonDFUModel alloc] init];
