//
//  MKGTBXPTAccelerometerController.m
...
@interface MKGTBXPTAccelerometerController ()<MFMailComposeViewControllerDelegate,
...
@implementation MKGTBXPTAccelerometerController

- (void)dealloc {
    NSLog(@"MKGTBXPTAccelerometerController销毁");
...
- (void)gt_bxpButtonAccHeaderView_syncButtonPressed:(BOOL)isOn {
    ...
    [MKGTMQTTInterface gt_bxpBXPTNotifyAccDataWithBleMac:self.bleMac notify:isOn macAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        ...
        if (isOn) {
            [[NSNotificationCenter defaultCenter] addObserver:self
                                                     selector:@selector(receiveAccDatas:)
                                                         name:MKGTReceiveBXPTAccDataNotification
                                                       object:nil];
        }else {
            [[NSNotificationCenter defaultCenter] removeObserver:self];
        }
