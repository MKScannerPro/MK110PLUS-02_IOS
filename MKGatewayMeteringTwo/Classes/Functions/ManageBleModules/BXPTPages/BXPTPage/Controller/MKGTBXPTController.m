...
@interface MKGTBXPTController ()<UITableViewDelegate,
...
@implementation MKGTBXPTController

- (void)dealloc {
    NSLog(@"MKGTBXPTController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 3 && indexPath.row == 0) {
        //Remote reminder
        MKGTBXPTRemoteReminderController *vc = [[MKGTBXPTRemoteReminderController alloc] init];
    ...
    if (indexPath.section == 3 && indexPath.row == 1) {
        //Motion event data
        MKGTBXPTMotionEventController *vc = [[MKGTBXPTMotionEventController alloc] init];
        vc.bleMac = self.deviceBleInfo[@"data"][@"mac"];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 3 && indexPath.row == 2) {
        //Accelerometer data
        MKGTBXPTAccelerometerController *vc = [[MKGTBXPTAccelerometerController alloc] init];
        vc.bleMac = self.deviceBleInfo[@"data"][@"mac"];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 3 && indexPath.row == 3) {
        ...
        MKGTBXPTAccParamsController *vc = [[MKGTBXPTAccParamsController alloc] init];
        vc.bleMac = self.deviceBleInfo[@"data"][@"mac"];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
    if (indexPath.section == 3 && indexPath.row == 4) {
        ...
        MKGTBXPTAdvParamsController *vc = [[MKGTBXPTAdvParamsController alloc] init];
        vc.bleMac = self.deviceBleInfo[@"data"][@"mac"];
        [self.navigationController pushViewController:vc animated:YES];
        return;
    }
...
- (void)readDatasFromDevice {
    ...
    [MKGTMQTTInterface gt_readBXPTConnectedStatusWithBleMacAddress:self.deviceBleInfo[@"data"][@"mac"] macAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
...
- (void)powerOffCmdToDevice {
    [[MKHudManager share] showHUDWithTitle:@"Waiting..." inView:self.view isPenetration:NO];
    [MKGTMQTTInterface gt_bxpBXPTPowerOffWithBleMac:self.deviceBleInfo[@"data"][@"mac"] macAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
        [self.navigationController popViewControllerAnimated:YES];
    } failedBlock:^(NSError * _Nonnull error) {
        [[MKHudManager share] hide];
...
- (void)loadSection2Datas {
    ...
    cellModel4.rightMsg = [NSString stringWithFormat:@"%@",self.deviceBleInfo[@"data"][@"battery_v"]];
...
- (void)loadSection3Datas {
    ...
    cellModel2.leftMsg = @"Motion event data";
    ...
    cellModel4.leftMsg = @"Accelerometer parameters";
