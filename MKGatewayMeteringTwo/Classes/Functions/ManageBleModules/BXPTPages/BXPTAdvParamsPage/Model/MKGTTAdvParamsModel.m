...
- (BOOL)readButtonAdvParams:(NSString *)bleMac {
    ...
    [MKGTMQTTInterface gt_readBXPTAdvParamsWithBleMacAddress:bleMac macAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
