...
@interface MKGTBXPButtonAdvParamsModel ()
...
@implementation MKGTBXPButtonAdvParamsModel
...
- (BOOL)readButtonAdvParams:(NSString *)bleMac {
    ...
    [MKGTMQTTInterface gt_bxpBtnReadAdvParamsWithBleMac:bleMac macAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
