...
@implementation MKGTReminderAlertViewModel
@end

@interface MKGTReminderColorButton : UIControl
...
@implementation MKGTReminderColorButton
...
- (UIImageView *)icon {
    if (!_icon) {
        ...
        _icon.image = LOADICON(@"MKGatewayMeteringTwo", @"MKGTReminderColorButton", @"gt_resetByButtonUnselectedIcon.png");
    }
    return _icon;
}
...
@interface MKGTReminderAlertView ()
...
@property (nonatomic, strong)MKGTReminderColorButton *redColor;

@property (nonatomic, strong)MKGTReminderColorButton *blueColor;

@property (nonatomic, strong)MKGTReminderColorButton *greenColor;

@end

@implementation MKGTReminderAlertView
...
- (void)setupColorIcons {
    self.redColor.icon.image = (self.currentColor == 0 ? LOADICON(@"MKGatewayMeteringTwo", @"MKGTReminderColorButton", @"gt_resetByButtonSelectedIcon.png") : LOADICON(@"MKGatewayMeteringTwo", @"MKGTReminderColorButton", @"gt_resetByButtonUnselectedIcon.png"));
    self.blueColor.icon.image = (self.currentColor == 1 ? LOADICON(@"MKGatewayMeteringTwo", @"MKGTReminderColorButton", @"gt_resetByButtonSelectedIcon.png") : LOADICON(@"MKGatewayMeteringTwo", @"MKGTReminderColorButton", @"gt_resetByButtonUnselectedIcon.png"));
    self.greenColor.icon.image = (self.currentColor == 2 ? LOADICON(@"MKGatewayMeteringTwo", @"MKGTReminderColorButton", @"gt_resetByButtonSelectedIcon.png") : LOADICON(@"MKGatewayMeteringTwo", @"MKGTReminderColorButton", @"gt_resetByButtonUnselectedIcon.png"));
}
...
- (MKGTReminderColorButton *)redColor {
    if (!_redColor) {
        _redColor = [[MKGTReminderColorButton alloc] init];
...
- (MKGTReminderColorButton *)blueColor {
    if (!_blueColor) {
        _blueColor = [[MKGTReminderColorButton alloc] init];
...
- (MKGTReminderColorButton *)greenColor {
    if (!_greenColor) {
        _greenColor = [[MKGTReminderColorButton alloc] init];
