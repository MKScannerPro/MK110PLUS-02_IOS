//
//  MKGTTofAccelerometerController.m
...
@interface MKGTTofAccelerometerController ()<MFMailComposeViewControllerDelegate,
...
@implementation MKGTTofAccelerometerController

- (void)dealloc {
    NSLog(@"MKGTTofAccelerometerController销毁");
...
- (void)gt_bxpButtonAccHeaderView_syncButtonPressed:(BOOL)isOn {
    ...
    [MKGTMQTTInterface gt_bxpMKTofNotifyAccDataWithBleMac:self.bleMac notify:isOn macAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
