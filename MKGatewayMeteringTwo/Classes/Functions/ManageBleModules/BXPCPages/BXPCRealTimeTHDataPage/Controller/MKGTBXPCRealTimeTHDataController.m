//
//  MKGTBXPCRealTimeTHDataController.m
...
@interface MKGTBXPCRealTimeTHDataController ()<MFMailComposeViewControllerDelegate,
...
@implementation MKGTBXPCRealTimeTHDataController

- (void)dealloc {
    NSLog(@"MKGTBXPCRealTimeTHDataController销毁");
...
- (void)gt_bxpButtonAccHeaderView_syncButtonPressed:(BOOL)isOn {
    ...
    [MKGTMQTTInterface gt_bxpBXPCNotifyRealTimeHTDataWithBleMac:self.bleMac notify:isOn macAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
...
- (void)gt_bxpButtonAccHeaderView_exportButtonPressed {
    ...
    [mailComposer addAttachmentData:emailData
                           ...
                           fileName:@"BXP-C RealTimeHTDatas.txt"];
