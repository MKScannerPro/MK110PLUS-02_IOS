//
//  MKGTBXPSHistoricalTHDataHeaderView.m
...
@interface MKGTBXPSHistoricalTHDataHeaderView ()
...
@implementation MKGTBXPSHistoricalTHDataHeaderView
...
- (void)syncButtonPressed {
    if ([self.delegate respondsToSelector:@selector(gt_BXPSHistoricalHTDataHeaderView_syncButtonPressed:)]) {
        [self.delegate gt_BXPSHistoricalHTDataHeaderView_syncButtonPressed:!self.syncButton.selected];
    }
}

- (void)deleteButtonPressed {
    if ([self.delegate respondsToSelector:@selector(gt_BXPSHistoricalHTDataHeaderView_deleteButtonPressed)]) {
        [self.delegate gt_BXPSHistoricalHTDataHeaderView_deleteButtonPressed];
    }
}

- (void)exportButtonPressed {
    if ([self.delegate respondsToSelector:@selector(gt_BXPSHistoricalHTDataHeaderView_exportButtonPressed)]) {
        [self.delegate gt_BXPSHistoricalHTDataHeaderView_exportButtonPressed];
    }
}
...
- (UIImageView *)synIcon {
    if (!_synIcon) {
        ...
        _synIcon.image = LOADICON(@"MKGatewayMeteringTwo", @"MKGTBXPSHistoricalTHDataHeaderView", @"gt_threeAxisAcceLoadingIcon.png");
    }
    return _synIcon;
}
...
- (UIButton *)exportButton {
    if (!_exportButton) {
        ...
        [_exportButton setImage:LOADICON(@"MKGatewayMeteringTwo", @"MKGTBXPSHistoricalTHDataHeaderView", @"gt_slotExportEnableIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)deleteButton {
    if (!_deleteButton) {
        ...
        [_deleteButton setImage:LOADICON(@"MKGatewayMeteringTwo", @"MKGTBXPSHistoricalTHDataHeaderView", @"gt_slotExportDeleteIcon.png") forState:UIControlStateNormal];
