//
//  MKGTBXPSAdvTriggerTwoStateCell.m
...
@implementation MKGTBXPSAdvTriggerTwoStateCellModel
...
@interface MKGTBXPSAdvTriggerTwoStateCell ()
...
@implementation MKGTBXPSAdvTriggerTwoStateCell

+ (MKGTBXPSAdvTriggerTwoStateCell *)initCellWithTableView:(UITableView *)tableView {
    MKGTBXPSAdvTriggerTwoStateCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKGTBXPSAdvTriggerTwoStateCellIdenty"];
    if (!cell) {
        cell = [[MKGTBXPSAdvTriggerTwoStateCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKGTBXPSAdvTriggerTwoStateCellIdenty"];
    }
    return cell;
}
...
- (void)setButtonPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(gt_BXPSAdvTriggerTwoStateCell_setPressed:beforeInterval:beforeTxPower:afterInterval:afterTxPower:)]) {
        [self.delegate gt_BXPSAdvTriggerTwoStateCell_setPressed:self.dataModel.slotIndex
...
#pragma mark - setter
- (void)setDataModel:(MKGTBXPSAdvTriggerTwoStateCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKGTBXPSAdvTriggerTwoStateCellModel.class]) {
        return;
    }
...
- (NSString *)getSlotTypeString:(MKGTBXPSAdvTriggerTwoStateCellSlotType)slotType {
    if (slotType == MKGTBXPSAdvTriggerTwoStateCellSlotTypeUID) {
        return @"UID";
    }
    if (slotType == MKGTBXPSAdvTriggerTwoStateCellSlotTypeURL) {
        return @"URL";
    }
    if (slotType == MKGTBXPSAdvTriggerTwoStateCellSlotTypeTLM) {
        return @"TLM";
    }
    if (slotType == MKGTBXPSAdvTriggerTwoStateCellSlotTypeBeacon) {
        return @"iBeacon";
    }
    if (slotType == MKGTBXPSAdvTriggerTwoStateCellSlotTypeTHInfo) {
        return @"T&H info";
    }
    if (slotType == MKGTBXPSAdvTriggerTwoStateCellSlotTypeSensorInfo) {
        return @"Sensor info";
    }
