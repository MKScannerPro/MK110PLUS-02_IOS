...
@implementation MKGTBXPSAdvNormalCellModel

- (CGFloat)fetchCellHeight {
    if (self.slotType == MKGTBXPSAdvNormalCellSlotTypeNoData) {
        return 44.f;
    }
    return 150.f;
}
...
@interface MKGTBXPSAdvNormalCell ()
...
@implementation MKGTBXPSAdvNormalCell

+ (MKGTBXPSAdvNormalCell *)initCellWithTableView:(UITableView *)tableView {
    MKGTBXPSAdvNormalCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKGTBXPSAdvNormalCellIdenty"];
    if (!cell) {
        cell = [[MKGTBXPSAdvNormalCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKGTBXPSAdvNormalCellIdenty"];
    }
    return cell;
}
...
- (void)layoutSubviews {
    ...
    if (self.dataModel.slotType == MKGTBXPSAdvNormalCellSlotTypeNoData) {
...
- (void)setButtonPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(gt_BXPSAdvNormalCell_setPressed:interval:txPower:)]) {
        [self.delegate gt_BXPSAdvNormalCell_setPressed:self.dataModel.slotIndex
...
#pragma mark - setter
- (void)setDataModel:(MKGTBXPSAdvNormalCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKGTBXPSAdvNormalCellModel.class]) {
        return;
    }
    ...
    if (_dataModel.slotType == MKGTBXPSAdvNormalCellSlotTypeNoData) {
...
- (NSString *)getSlotTypeString:(MKGTBXPSAdvNormalCellSlotType)slotType {
    if (slotType == MKGTBXPSAdvNormalCellSlotTypeUID) {
        return @"UID";
    }
    if (slotType == MKGTBXPSAdvNormalCellSlotTypeURL) {
        return @"URL";
    }
    if (slotType == MKGTBXPSAdvNormalCellSlotTypeTLM) {
        return @"TLM";
    }
    if (slotType == MKGTBXPSAdvNormalCellSlotTypeBeacon) {
        return @"iBeacon";
    }
    if (slotType == MKGTBXPSAdvNormalCellSlotTypeSensorInfo) {
        return @"Sensor info";
    }
    if (slotType == MKGTBXPSAdvNormalCellSlotTypeTHInfo) {
        return @"T&H info";
    }
