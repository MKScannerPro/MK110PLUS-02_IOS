...
@implementation MKGTBXPSAdvTriggerCellModel

- (CGFloat)fetchCellHeight {
    if (self.slotType == MKGTBXPSAdvTriggerCellSlotTypeNoData) {
        return 44.f;
    }
    return 150.f;
}
...
@interface MKGTBXPSAdvTriggerCell ()
...
@implementation MKGTBXPSAdvTriggerCell

+ (MKGTBXPSAdvTriggerCell *)initCellWithTableView:(UITableView *)tableView {
    MKGTBXPSAdvTriggerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKGTBXPSAdvTriggerCellIdenty"];
    if (!cell) {
        cell = [[MKGTBXPSAdvTriggerCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKGTBXPSAdvTriggerCellIdenty"];
    }
    return cell;
}
...
- (void)layoutSubviews {
    ...
    if (self.dataModel.slotType == MKGTBXPSAdvTriggerCellSlotTypeNoData) {
...
- (void)setButtonPressed {
    ...
    if ([self.delegate respondsToSelector:@selector(gt_BXPSAdvTriggerCell_setPressed:interval:txPower:)]) {
        [self.delegate gt_BXPSAdvTriggerCell_setPressed:self.dataModel.slotIndex
...
#pragma mark - setter
- (void)setDataModel:(MKGTBXPSAdvTriggerCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKGTBXPSAdvTriggerCellModel.class]) {
        return;
    }
    ...
    if (_dataModel.slotType == MKGTBXPSAdvTriggerCellSlotTypeNoData) {
...
- (NSString *)getSlotTypeString:(MKGTBXPSAdvTriggerCellSlotType)slotType {
    if (slotType == MKGTBXPSAdvTriggerCellSlotTypeUID) {
        return @"UID";
    }
    if (slotType == MKGTBXPSAdvTriggerCellSlotTypeURL) {
        return @"URL";
    }
    if (slotType == MKGTBXPSAdvTriggerCellSlotTypeTLM) {
        return @"TLM";
    }
    if (slotType == MKGTBXPSAdvTriggerCellSlotTypeBeacon) {
        return @"iBeacon";
    }
    if (slotType == MKGTBXPSAdvTriggerCellSlotTypeSensorInfo) {
        return @"Sensor info";
    }
    if (slotType == MKGTBXPSAdvTriggerCellSlotTypeTHInfo) {
        return @"T&H info";
    }
