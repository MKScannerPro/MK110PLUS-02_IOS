...
@interface MKGTBXPSAdvParamsModel ()
...
- (BOOL)readBXPSAdvParams:(NSString *)bleMac {
    ...
    [MKGTMQTTInterface gt_readBXPSAdvParamsWithBleMacAddress:bleMac macAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
