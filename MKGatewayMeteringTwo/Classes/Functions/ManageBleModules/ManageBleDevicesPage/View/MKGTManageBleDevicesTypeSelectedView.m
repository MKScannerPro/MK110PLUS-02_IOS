//
//  MKGTManageBleDevicesTypeSelectedView.m
...
@interface MKGTManageBleDevicesTypeSelectedView ()<UIGestureRecognizerDelegate,
UITableViewDelegate,
UITableViewDataSource,
MKGTManageBleDevicesTypeSelectedCellDelegate>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, copy)void (^selectedBlock)(MKGTManageBleDevicesTypeSelectedViewType selectedType);

@property (nonatomic, assign)MKGTManageBleDevicesTypeSelectedViewType selectedType;

@end

@implementation MKGTManageBleDevicesTypeSelectedView

- (void)dealloc{
    NSLog(@"MKGTManageBleDevicesTypeSelectedView销毁");
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MKGTManageBleDevicesTypeSelectedCell *cell = [MKGTManageBleDevicesTypeSelectedCell initCellWithTableView:tableView];
...
#pragma mark - MKGTManageBleDevicesTypeSelectedCellDelegate
- (void)gt_manageBleDevicesTypeSelectedCell_selected:(BOOL)selected index:(NSInteger)index {
    self.selectedType = index;
    for (NSInteger i = 0; i < self.dataList.count; i ++) {
        MKGTManageBleDevicesTypeSelectedCellModel *cellModel = self.dataList[i];
...
+ (void)showWithType:(MKGTManageBleDevicesTypeSelectedViewType)type
    ...
    MKGTManageBleDevicesTypeSelectedView *view = [[MKGTManageBleDevicesTypeSelectedView alloc] init];
...
- (void)loadSectionDatas {
    MKGTManageBleDevicesTypeSelectedCellModel *cellModel1 = [[MKGTManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel1.index = 0;
    cellModel1.selected = (self.selectedType == 0);
    cellModel1.msg = @"BXP-B-D";
    [self.dataList addObject:cellModel1];
    
    MKGTManageBleDevicesTypeSelectedCellModel *cellModel2 = [[MKGTManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel2.index = 1;
    cellModel2.selected = (self.selectedType == 1);
    cellModel2.msg = @"BXP-B-CR";
    [self.dataList addObject:cellModel2];
    
    MKGTManageBleDevicesTypeSelectedCellModel *cellModel3 = [[MKGTManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel3.index = 2;
    cellModel3.selected = (self.selectedType == 2);
    cellModel3.msg = @"BXP-C";
    [self.dataList addObject:cellModel3];
    
    MKGTManageBleDevicesTypeSelectedCellModel *cellModel4 = [[MKGTManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel4.index = 3;
    cellModel4.selected = (self.selectedType == 3);
    cellModel4.msg = @"BXP-D";
    [self.dataList addObject:cellModel4];
    
    MKGTManageBleDevicesTypeSelectedCellModel *cellModel5 = [[MKGTManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel5.index = 4;
    cellModel5.selected = (self.selectedType == 4);
    cellModel5.msg = @"BXP-T";
    [self.dataList addObject:cellModel5];
    
    MKGTManageBleDevicesTypeSelectedCellModel *cellModel6 = [[MKGTManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel6.index = 5;
    cellModel6.selected = (self.selectedType == 5);
    cellModel6.msg = @"BXP-S";
    [self.dataList addObject:cellModel6];
    
    MKGTManageBleDevicesTypeSelectedCellModel *cellModel7 = [[MKGTManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel7.index = 6;
    cellModel7.selected = (self.selectedType == 6);
    cellModel7.msg = @"MK PIR";
    [self.dataList addObject:cellModel7];
    
    MKGTManageBleDevicesTypeSelectedCellModel *cellModel8 = [[MKGTManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel8.index = 7;
    cellModel8.selected = (self.selectedType == 7);
    cellModel8.msg = @"MK TOF";
    [self.dataList addObject:cellModel8];
    
    MKGTManageBleDevicesTypeSelectedCellModel *cellModel9 = [[MKGTManageBleDevicesTypeSelectedCellModel alloc] init];
    cellModel9.index = 8;
