//
//  MKGTManageBleDevicesSearchButton.m
...
@implementation MKGTManageBleDevicesSearchButtonModel
@end

@interface MKGTManageBleDevicesSearchButton ()
...
@implementation MKGTManageBleDevicesSearchButton
...
- (void)clearButtonPressed{
    ...
    if ([self.delegate respondsToSelector:@selector(gt_scanSearchButtonClearMethod)]) {
        [self.delegate gt_scanSearchButtonClearMethod];
    }
}

- (void)searchButtonPressed{
    if ([self.delegate respondsToSelector:@selector(gt_scanSearchButtonMethod)]) {
        [self.delegate gt_scanSearchButtonMethod];
    }
}

#pragma mark - setting
- (void)setDataModel:(MKGTManageBleDevicesSearchButtonModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKGTManageBleDevicesSearchButtonModel.class]) {
        return;
    }
...
- (UIImageView *)searchIcon{
    if (!_searchIcon) {
        ...
        _searchIcon.image = LOADICON(@"MKGatewayMeteringTwo", @"MKGTManageBleDevicesSearchButton", @"gt_searchGrayIcon.png");
    }
    return _searchIcon;
}
...
- (UIButton *)clearButton{
    if (!_clearButton) {
        ...
        [_clearButton setImage:LOADICON(@"MKGatewayMeteringTwo", @"MKGTManageBleDevicesSearchButton", @"gt_clearButtonIcon.png") forState:UIControlStateNormal];
