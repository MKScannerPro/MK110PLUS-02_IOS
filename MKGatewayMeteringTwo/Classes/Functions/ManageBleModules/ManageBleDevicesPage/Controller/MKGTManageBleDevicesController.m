//
//  MKGTManageBleDevicesController.m
...
@interface MKGTManageBleDevicesController ()<UITableViewDelegate,
...
@implementation MKGTManageBleDevicesController

- (void)dealloc {
    NSLog(@"MKGTManageBleDevicesController销毁");
