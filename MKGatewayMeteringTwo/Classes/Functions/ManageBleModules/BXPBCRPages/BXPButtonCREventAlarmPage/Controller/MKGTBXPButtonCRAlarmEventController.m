//
//  MKGTBXPButtonCRAlarmEventController.m
...
@interface MKGTBXPButtonCRAlarmEventController ()<MFMailComposeViewControllerDelegate,
MKGTBXPButtonCRAlarmEventHeaderDelegate>

@property (nonatomic, strong)MKGTBXPButtonCRAlarmEventHeader *headerView;

@property (nonatomic, strong)UITextView *textView;

@property (nonatomic, strong)NSDateFormatter *dateFormatter;

@property (nonatomic, strong)MKGTBXPButtonCRAlarmEventModel *dataModel;

@end

@implementation MKGTBXPButtonCRAlarmEventController

- (void)dealloc {
    NSLog(@"MKGTBXPButtonCRAlarmEventController销毁");
...
#pragma mark - MKGTBXPButtonCRAlarmEventHeaderDelegate
...
#pragma mark - getter
- (MKGTBXPButtonCRAlarmEventHeader *)headerView {
    if (!_headerView) {
        _headerView = [[MKGTBXPButtonCRAlarmEventHeader alloc] init];
...
- (MKGTBXPButtonCRAlarmEventModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGTBXPButtonCRAlarmEventModel alloc] init];
    }
    return _dataModel;
}
