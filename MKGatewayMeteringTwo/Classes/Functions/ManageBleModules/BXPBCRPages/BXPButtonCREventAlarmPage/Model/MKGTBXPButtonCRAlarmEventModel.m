...
- (BOOL)notifyAlarmEvent:(NSString *)bleMac
    ...
    [MKGTMQTTInterface gt_BXPCRNotifyAlarmDataWithBleMac:bleMac alarmEventType:eventType notify:notify macAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
