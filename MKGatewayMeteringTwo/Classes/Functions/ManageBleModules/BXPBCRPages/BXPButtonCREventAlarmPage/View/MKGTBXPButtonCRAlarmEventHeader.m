//
//  MKGTBXPButtonCRAlarmEventHeader.m
...
@interface MKGTBXPButtonCRAlarmEventHeader ()
...
@implementation MKGTBXPButtonCRAlarmEventHeader
...
- (void)syncButtonPressed {
    if ([self.delegate respondsToSelector:@selector(gt_bxpButtonCRAlarmEventHeaderView_syncButtonPressed:)]) {
        [self.delegate gt_bxpButtonCRAlarmEventHeaderView_syncButtonPressed:!self.syncButton.selected];
    }
}

- (void)exportButtonPressed {
    if ([self.delegate respondsToSelector:@selector(gt_bxpButtonCRAlarmEventHeaderView_exportButtonPressed)]) {
        [self.delegate gt_bxpButtonCRAlarmEventHeaderView_exportButtonPressed];
    }
}
...
- (UIImageView *)synIcon {
    if (!_synIcon) {
        ...
        _synIcon.image = LOADICON(@"MKGatewayMeteringTwo", @"MKGTBXPButtonCRAlarmEventHeader", @"gt_threeAxisAcceLoadingIcon.png");
    }
    return _synIcon;
}
...
- (UIButton *)exportButton {
    if (!_exportButton) {
        ...
        [_exportButton setImage:LOADICON(@"MKGatewayMeteringTwo", @"MKGTBXPButtonCRAlarmEventHeader", @"gt_slotExportEnableIcon.png") forState:UIControlStateNormal];
