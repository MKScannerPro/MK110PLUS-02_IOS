...
@interface MKGTBXPButtonCRAdvParamsModel ()
...
- (BOOL)readButtonAdvParams:(NSString *)bleMac {
    ...
    [MKGTMQTTInterface gt_bxpBtnCRReadAdvParamsWithBleMac:bleMac macAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
