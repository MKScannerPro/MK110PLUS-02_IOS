//
//  MKGTBXPButtonCRAccDataController.m
...
@interface MKGTBXPButtonCRAccDataController ()<MFMailComposeViewControllerDelegate,
...
@implementation MKGTBXPButtonCRAccDataController

- (void)dealloc {
    NSLog(@"MKGTBXPButtonCRAccDataController销毁");
...
- (void)gt_bxpButtonAccHeaderView_syncButtonPressed:(BOOL)isOn {
    ...
    [MKGTMQTTInterface gt_bxpBtnCRNotifyAccDataWithBleMac:self.bleMac notify:isOn macAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        ...
        if (isOn) {
            [[NSNotificationCenter defaultCenter] addObserver:self
                                                     selector:@selector(receiveAccDatas:)
                                                         name:MKGTReceiveBXPBtnCRAccDataNotification
                                                       object:nil];
        }else {
            [[NSNotificationCenter defaultCenter] removeObserver:self];
        }
