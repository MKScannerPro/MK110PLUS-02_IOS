//
//  MKGTConnectedDeviceWriteAlertView.m
...
@interface MKGTConnectedDeviceWriteAlertView ()
...
@implementation MKGTConnectedDeviceWriteAlertView

- (void)dealloc {
    NSLog(@"MKGTConnectedDeviceWriteAlertView销毁");
}
