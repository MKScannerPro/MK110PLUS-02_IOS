...
@implementation MKGTMqttServerLwtViewModel
@end

@interface MKGTMqttServerLwtView ()
...
@implementation MKGTMqttServerLwtView
...
- (void)lwtButtonPressed {
    ...
    UIImage *lwtIcon = (self.lwtButton.selected ? LOADICON(@"MKGatewayMeteringTwo", @"MKGTMqttServerLwtView", @"gt_switchSelectedIcon.png") : LOADICON(@"MKGatewayMeteringTwo", @"MKGTMqttServerLwtView", @"gt_switchUnselectedIcon.png"));
...
- (void)retainButtonPressed {
    ...
    UIImage *retainIcon = (self.retainButton.selected ? LOADICON(@"MKGatewayMeteringTwo", @"MKGTMqttServerLwtView", @"gt_switchSelectedIcon.png") : LOADICON(@"MKGatewayMeteringTwo", @"MKGTMqttServerLwtView", @"gt_switchUnselectedIcon.png"));
...
#pragma mark - setter
- (void)setDataModel:(MKGTMqttServerLwtViewModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKGTMqttServerLwtViewModel.class]) {
        return;
    }
...
- (UIButton *)lwtButton {
    if (!_lwtButton) {
        ...
        [_lwtButton setImage:LOADICON(@"MKGatewayMeteringTwo", @"MKGTMqttServerLwtView", @"gt_switchUnselectedIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)retainButton {
    if (!_retainButton) {
        ...
        [_retainButton setImage:LOADICON(@"MKGatewayMeteringTwo", @"MKGTMqttServerLwtView", @"gt_switchUnselectedIcon.png") forState:UIControlStateNormal];
