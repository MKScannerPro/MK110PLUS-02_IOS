//
//  MKGTMqttServerConfigFooterView.h
...
@interface MKGTMqttServerConfigFooterViewModel : NSObject
...
@protocol MKGTMqttServerConfigFooterViewDelegate <NSObject>
...
@interface MKGTMqttServerConfigFooterView : UIView

@property (nonatomic, strong)MKGTMqttServerConfigFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKGTMqttServerConfigFooterViewDelegate>delegate;
