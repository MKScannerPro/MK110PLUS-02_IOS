...
- (BOOL)readDeviceInfo {
    ...
    [MKGTMQTTInterface gt_readDeviceInfoWithMacAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        ...
        self.wifiStaMac = [MKGTDeviceModeManager shared].macAddress;
