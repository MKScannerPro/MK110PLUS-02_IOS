...
@interface MKGTDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKGTDeviceInfoModel *dataModel;

@end

@implementation MKGTDeviceInfoController

- (void)dealloc {
    NSLog(@"MKGTDeviceInfoController销毁");
}
...
- (MKGTDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGTDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
