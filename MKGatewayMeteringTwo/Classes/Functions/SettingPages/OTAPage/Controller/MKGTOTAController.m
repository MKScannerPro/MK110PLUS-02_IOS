...
@interface MKGTOTAController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKGTOTAPageModel *dataModel;

@end

@implementation MKGTOTAController

- (void)dealloc {
    NSLog(@"MKGTOTAController销毁");
...
- (MKGTOTAPageModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGTOTAPageModel alloc] init];
    }
    return _dataModel;
}
