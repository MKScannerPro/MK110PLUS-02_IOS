...
@interface MKGTAdvBeaconParamsModel : NSObject<gt_advertiseBeaconProtocol>
...
- (BOOL)configAdvBeaconDatas {
    ...
    [MKGTMQTTInterface gt_configAdvertiseBeaconParams:dataModel macAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
