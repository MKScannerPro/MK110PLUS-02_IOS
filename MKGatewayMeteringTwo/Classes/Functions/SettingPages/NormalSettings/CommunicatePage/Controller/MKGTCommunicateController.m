...
@interface MKGTCommunicateController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKGTCommunicateModel *dataModel;

@end

@implementation MKGTCommunicateController

- (void)dealloc {
    NSLog(@"MKGTCommunicateController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMeteringTwo", @"MKGTCommunicateController", @"gt_saveIcon.png") forState:UIControlStateNormal];
...
- (MKGTCommunicateModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGTCommunicateModel alloc] init];
    }
    return _dataModel;
}
