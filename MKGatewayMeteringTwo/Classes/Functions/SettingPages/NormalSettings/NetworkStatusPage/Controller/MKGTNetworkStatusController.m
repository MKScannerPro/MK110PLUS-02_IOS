...
@interface MKGTNetworkStatusController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKGTNetworkStatusModel *dataModel;

@end

@implementation MKGTNetworkStatusController

- (void)dealloc {
    NSLog(@"MKGTNetworkStatusController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMeteringTwo", @"MKGTNetworkStatusController", @"gt_saveIcon.png") forState:UIControlStateNormal];
...
- (MKGTNetworkStatusModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGTNetworkStatusModel alloc] init];
    }
    return _dataModel;
}
