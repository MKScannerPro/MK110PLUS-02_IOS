...
@interface MKGTDataReportController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKGTDataReportModel *dataModel;

@end

@implementation MKGTDataReportController

- (void)dealloc {
    NSLog(@"MKGTDataReportController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMeteringTwo", @"MKGTDataReportController", @"gt_saveIcon.png") forState:UIControlStateNormal];
...
- (MKGTDataReportModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGTDataReportModel alloc] init];
    }
    return _dataModel;
}
