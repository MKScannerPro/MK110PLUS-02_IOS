...
@interface MKGTAdvBeaconParamsV2Model : NSObject<gt_advertiseBeaconV2Protocol>
...
@implementation MKGTAdvBeaconParamsV2Model
@end

@interface MKGTAdvBeaconV2Model ()
...
@implementation MKGTAdvBeaconV2Model
...
- (BOOL)readAdvBeaconDatas {
    ...
    [MKGTMQTTInterface gt_readAdvertiseBeaconParamsWithMacAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAdvBeaconDatas {
    ...
    MKGTAdvBeaconParamsV2Model *dataModel = [[MKGTAdvBeaconParamsV2Model alloc] init];
    ...
    [MKGTMQTTInterface gt_configV2AdvertiseBeaconParams:dataModel macAddress:[MKGTDeviceModeManager shared].macAddress topic:[MKGTDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
