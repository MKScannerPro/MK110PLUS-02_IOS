...
@interface MKGTReconnectTimeController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKGTReconnectTimeModel *dataModel;

@end

@implementation MKGTReconnectTimeController

- (void)dealloc {
    NSLog(@"MKGTReconnectTimeController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMeteringTwo", @"MKGTReconnectTimeController", @"gt_saveIcon.png") forState:UIControlStateNormal];
...
- (MKGTReconnectTimeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGTReconnectTimeModel alloc] init];
    }
    return _dataModel;
}
