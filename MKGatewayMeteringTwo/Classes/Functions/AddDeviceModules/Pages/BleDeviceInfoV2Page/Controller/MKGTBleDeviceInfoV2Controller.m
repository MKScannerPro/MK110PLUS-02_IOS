//
//  MKGTBleDeviceInfoV2Controller.m
...
@interface MKGTBleDeviceInfoV2Controller ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKGTBleDeviceInfoV2Model *dataModel;

@end

@implementation MKGTBleDeviceInfoV2Controller

- (void)dealloc {
    NSLog(@"MKGTBleDeviceInfoV2Controller销毁");
...
- (MKGTBleDeviceInfoV2Model *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGTBleDeviceInfoV2Model alloc] init];
    }
    return _dataModel;
}
