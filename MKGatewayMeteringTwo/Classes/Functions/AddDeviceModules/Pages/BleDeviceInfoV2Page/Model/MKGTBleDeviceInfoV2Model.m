...
@interface MKGTBleDeviceInfoV2Model ()
...
@implementation MKGTBleDeviceInfoV2Model
...
- (BOOL)readBleFirmware {
    __block BOOL success = NO;
    [MKGTInterface gt_readBLEFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readWifiFirmware {
    __block BOOL success = NO;
    [MKGTInterface gt_readWifiFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
