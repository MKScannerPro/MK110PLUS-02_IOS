...
@implementation MKGTNearbyWifiCellModel
@end

@interface MKGTNearbyWifiCell ()
...
@implementation MKGTNearbyWifiCell


+ (MKGTNearbyWifiCell *)initCellWithTableView:(UITableView *)tableView {
    MKGTNearbyWifiCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKGTNearbyWifiCellIdenty"];
    if (!cell) {
        cell = [[MKGTNearbyWifiCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKGTNearbyWifiCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKGTNearbyWifiCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKGTNearbyWifiCellModel.class]) {
        return;
    }
    //顶部
