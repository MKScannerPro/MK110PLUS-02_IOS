//
//  MKGTBleMeteringSettingsController.m
...
@interface MKGTBleMeteringSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKGTBleMeteringSettingsModel *dataModel;

@end

@implementation MKGTBleMeteringSettingsController

- (void)dealloc {
    NSLog(@"MKGTBleMeteringSettingsController销毁");
}
...
#pragma mark - UI
- (void)loadSubViews {
    self.defaultTitle = @"Metering Settings";
    [self.rightButton setImage:LOADICON(@"MKGatewayMeteringTwo", @"MKGTBleMeteringSettingsController", @"gt_saveIcon.png") forState:UIControlStateNormal];
...
- (MKGTBleMeteringSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGTBleMeteringSettingsModel alloc] init];
    }
    return _dataModel;
}
