//
//  MKGTBleMeteringSettingsModel.m
...
@interface MKGTBleMeteringSettingsModel ()
...
@implementation MKGTBleMeteringSettingsModel
...
- (BOOL)readMeteringSwitch {
    ...
    [MKGTInterface gt_readMeteringSwitchWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configMeteringSwitch {
    __block BOOL success = NO;
    [MKGTInterface gt_configMeteringSwitch:self.isOn sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readLoadDetection {
    __block BOOL success = NO;
    [MKGTInterface gt_readLoadDetectionNotificationStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLoadDetection {
    __block BOOL success = NO;
    [MKGTInterface gt_configLoadDetectionNotificationStatus:self.loadDetection sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPowerInterval {
    __block BOOL success = NO;
    [MKGTInterface gt_readPowerReportIntervalWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPowerInterval {
    __block BOOL success = NO;
    [MKGTInterface gt_configPowerReportInterval:[self.powerInterval integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEnergyInterval {
    __block BOOL success = NO;
    [MKGTInterface gt_readEnergyReportIntervalWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEnergyInterval {
    __block BOOL success = NO;
    [MKGTInterface gt_configEnergyReportInterval:[self.energyInterval integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
