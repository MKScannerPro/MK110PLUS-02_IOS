...
@interface MKGTBleAdvBeaconV2Model ()
...
@implementation MKGTBleAdvBeaconV2Model
...
- (BOOL)readAdvStatus {
    ...
    [MKGTInterface gt_readAdvertiseBeaconStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAdvStatus {
    __block BOOL success = NO;
    [MKGTInterface gt_configAdvertiseBeaconStatus:self.advertise sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readMajor {
    __block BOOL success = NO;
    [MKGTInterface gt_readBeaconMajorWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configMajor {
    __block BOOL success = NO;
    [MKGTInterface gt_configBeaconMajor:[self.major integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readMinor {
    __block BOOL success = NO;
    [MKGTInterface gt_readBeaconMinorWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configMinor {
    __block BOOL success = NO;
    [MKGTInterface gt_configBeaconMinor:[self.minor integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readUUID {
    __block BOOL success = NO;
    [MKGTInterface gt_readBeaconUUIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configUUID {
    __block BOOL success = NO;
    [MKGTInterface gt_configBeaconUUID:self.uuid sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readInterval {
    __block BOOL success = NO;
    [MKGTInterface gt_readBeaconAdvIntervalWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configInterval {
    __block BOOL success = NO;
    [MKGTInterface gt_configAdvInterval:[self.advInterval integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readTxPower {
    __block BOOL success = NO;
    [MKGTInterface gt_readBeaconTxPowerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configTxPower {
    __block BOOL success = NO;
    [MKGTInterface gt_configTxPower:self.txPower sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readRssi1m {
    __block BOOL success = NO;
    [MKGTInterface gt_readBeaconRssiWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configRssi1m {
    __block BOOL success = NO;
    [MKGTInterface gt_configBeaconRssi:self.rssi1m sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readConnectable {
    __block BOOL success = NO;
    [MKGTInterface gt_readConnectableWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configConnectable {
    __block BOOL success = NO;
    [MKGTInterface gt_configConnectable:self.connectable sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
