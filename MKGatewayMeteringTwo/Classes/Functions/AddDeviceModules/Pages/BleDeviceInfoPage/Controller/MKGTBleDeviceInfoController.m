...
@interface MKGTBleDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKGTBleDeviceInfoModel *dataModel;

@end

@implementation MKGTBleDeviceInfoController

- (void)dealloc {
    NSLog(@"MKGTBleDeviceInfoController销毁");
...
- (MKGTBleDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKGTBleDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
