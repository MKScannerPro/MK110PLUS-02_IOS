...
static MKGTUserLoginManager *loginManager = nil;
static dispatch_once_t onceToken;

@interface MKGTUserLoginManager ()
...
+ (MKGTUserLoginManager *)shared {
    dispatch_once(&onceToken, ^{
        if (!loginManager) {
            loginManager = [MKGTUserLoginManager new];
        }
    });
    return loginManager;
}
