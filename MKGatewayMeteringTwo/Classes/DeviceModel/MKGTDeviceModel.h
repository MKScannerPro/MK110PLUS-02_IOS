...
typedef NS_ENUM(NSInteger, MKGTDeviceModelState) {
    MKGTDeviceModelStateOffline,
    MKGTDeviceModelStateOnline,
};

//当设备离线的时候发出通知
extern NSString *const MKGTDeviceModelOfflineNotification;

@protocol MKGTDeviceModelDelegate <NSObject>
...
/**
 设备的状态，离线、在线
 */
@property (nonatomic, assign)MKGTDeviceModelState onLineState;

#pragma mark - 业务流程相关

@property (nonatomic, weak)id <MKGTDeviceModelDelegate>delegate;
