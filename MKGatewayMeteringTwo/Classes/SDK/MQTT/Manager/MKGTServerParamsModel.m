...
static NSString *const fileName = @"MKGTServerParams.txt";

@interface MKGTServerParamsModel ()
...
@implementation MKGTServerParamsModel
...
- (BOOL)checkServerDataProtocol:(id <MKGTServerParamsProtocol>)protocol {
