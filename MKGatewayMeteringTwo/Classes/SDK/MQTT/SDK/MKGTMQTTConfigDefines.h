...
typedef NS_ENUM(NSInteger, mk_gt_keyResetType) {
    mk_gt_keyResetType_powerOnOneMin,     //Press in 1 min after powered
    mk_gt_keyResetType_pressAnyTime,      //Press any time
};
...
typedef NS_ENUM(NSInteger, mk_gt_filterRelationship) {
    ...
    mk_gt_filterRelationship_advNameAndRawDataAndMac,
    mk_gt_filterRelationship_advNameOrRawData,
    mk_gt_filterRelationship_advNameAndRawMac,
};

typedef NS_ENUM(NSInteger, mk_gt_filterByTLM) {
    mk_gt_filterByTLM_nonEncrypted,        //Non-encrypted type TLM
    mk_gt_filterByTLM_encrypted,           //Encryption type TLM
    mk_gt_filterByTLM_all,                //Filter all Eddystone_TLM data
};

typedef NS_ENUM(NSInteger, mk_gt_filterByOther) {
    mk_gt_filterByOther_A,                 //Filter by A condition.
    mk_gt_filterByOther_AB,                //Filter by A & B condition.
    mk_gt_filterByOther_AOrB,              //Filter by A | B condition.
    mk_gt_filterByOther_ABC,               //Filter by A & B & C condition.
    mk_gt_filterByOther_ABOrC,             //Filter by (A & B) | C condition.
    mk_gt_filterByOther_AOrBOrC,           //Filter by A | B | C condition.
};

typedef NS_ENUM(NSInteger, mk_gt_duplicateDataFilter) {
    mk_gt_duplicateDataFilter_none,
    mk_gt_duplicateDataFilter_mac,
    mk_gt_duplicateDataFilter_macAndDataType,
    mk_gt_duplicateDataFilter_macAndRawData
};

typedef NS_ENUM(NSInteger, mk_gt_PHYMode) {
...
@protocol mk_gt_BLEFilterRawDataProtocol <NSObject>
...
@protocol mk_gt_BLEFilterBXPButtonProtocol <NSObject>
...
@protocol mk_gt_BLEFilterPirProtocol <NSObject>
...
@protocol mk_gt_mqttModifyWifiProtocol <NSObject>
...
@protocol mk_gt_mqttModifyWifiEapCertProtocol <NSObject>
...
@protocol mk_gt_mqttModifyNetworkProtocol <NSObject>
...
@protocol mk_gt_modifyMqttServerProtocol <NSObject>
...
@protocol mk_gt_modifyMqttServerCertsProtocol <NSObject>
...
@protocol gt_advertiseBeaconProtocol <NSObject>
